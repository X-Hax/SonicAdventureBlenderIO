...
to_register = [
    ...
    filehandlers.SAIO_FH_SA1MDL,
    filehandlers.SAIO_FH_SA2MDL,
    filehandlers.SAIO_FH_SA2BMDL,
    filehandlers.SAIO_FH_SA1LVL,
    filehandlers.SAIO_FH_SA2LVL,
    filehandlers.SAIO_FH_SA2BLVL,
